						...
						if(res.length){
							...
							win.onload=function(){
								...
								for(var i=0;i<res.length;i++){
									...
									if(rec.manhanvien!=oldMaNhanVien){
										if(row){
											...
											if(ct){
												row.cells[33].innerHTML=ct.bold;
												row.cells[34].innerHTML=ct.light;
												row.cells[35].innerHTML=ct.trucbach;
												row.cells[36].innerHTML=ct.hanoipre;
												row.cells[37].innerHTML=ct.bold+ct.light+ct.trucbach+ct.hanoipre;
												row.cells[38].innerHTML=ct.bold+ct.light;
											}
											...
											row.cells[32].innerHTML="<b>"+Math.round(sumSanLuong*10)/10+"</b>";
											total[22]+=sumSanLuong;
											row.cells[39].innerHTML="<b>"+Math.round(sumTrongDiem*10)/10+"</b>";
											row.cells[40].innerHTML="B&L";
											total[29]+=sumTrongDiem;
											total[0]+=DINHMUC_NC;
									...
									if(!wSanLuong[rec.tuan]) wSanLuong[rec.tuan]={bold:0,light:0,trucbach:0,hanoipre:0};
								...
								if(row){
									...
									row.cells[37].innerHTML=rec.sanluongkhoan;
									row.cells[38].innerHTML=rec.sltrongdiem;
									if(oldMaDiemBan!=rec.madiemban){
										row.cells[4].innerHTML+="<br/>"+rec.loaihinh;
										row.cells[5].innerHTML+="<br/>"+rec.tendiemban;
										row.cells[6].innerHTML+="<br/>"+rec.sonha;
