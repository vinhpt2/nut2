var Com_HrmsMonthlyMS07Report={
	...
	runReport:function(){
		if(numTinhCong_Year.value&&numTinhCong_Month.value){
			...
			NUT_DS.select({url:url+"rpt_ms07",where:[["nam","=",numTinhCong_Year.value],["thang","=",numTinhCong_Month.value],["madoitac","=",cboTinhCong_DoiTac.value],["vitrilv","=",vitrilv],(_context.user.kvhcs.length?["makhuvuc","in",_context.user.kvhcs]:["thitruong","=",cboTinhCong_ThiTruong.value]),["dulieu","=",1]]},function(res){
				if(res.length){
