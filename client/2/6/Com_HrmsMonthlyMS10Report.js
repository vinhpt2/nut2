var Com_HrmsMonthlyMS10Report={
	...
	runReport:function(){
		if(numTinhCong_Year.value&&numTinhCong_Month.value){
			...
			NUT_DS.select({url:url+"rpt_ms10",where:[["nam","=",numTinhCong_Year.value],["thang","=",numTinhCong_Month.value],["madoitac","=",cboTinhCong_DoiTac.value],["vitrilv","=",vitrilv]]},function(res){
				if(res.length){
